...
type Props = { homes: RentalHome[]; loading: boolean; onClear: () => void }

export function RentalHomeGrid({ homes, loading, onClear }: Props) {
  ...
  return <div className="homes-grid">{homes.map((home) => <RentalHomeCard key={home.id} home={home} />)}</div>
}
